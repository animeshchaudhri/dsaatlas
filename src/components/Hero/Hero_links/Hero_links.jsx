  ...
  return (
    <div>
      ...
      <p className="mb-6 max-w-xl leading-7 text-gray-400">
        ...
        interview setting. Algochurn is a FREE platform that provides the most
      ...
      <p className="mb-6 text-base text-gray-400">
        Explore{" "}
        <span>
          <a className="text-[#06b6d4]">Playground </a>
        </span>
        to generate code with Voice and Text commands.
      </p>
